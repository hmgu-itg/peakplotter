...
@click.option('-s', '--signif', type=click.FLOAT, default=5e-8help = 'The significance level above which to declare a variant significant. Scientific notation (such as 5e-8) is fine.')
