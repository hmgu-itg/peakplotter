...
our $geneBedfile    = "/nfs/team144/ds26/FunctionalAnnotation/20150505_new_tool/data/gencode.v19.annotation_20150603_sorted.bed";
our $proteinBedfile = "/nfs/team144/ds26/FunctionalAnnotation/20150505_new_tool/data/gencode.v19.annotation_20150603_protein_coding_genes.bed";
...
sub Gene {
    ...
    foreach my $variant (keys %variants){
        ...
        my $URL = "http://grch37.rest.ensembl.org/overlap/region/human/$query_string?feature=gene";
